...
public class WxPayApi {
    ...
    public static Map<String,String> asyCheckReturnParams(HttpServletRequest request){
        return wxPayApi.wxPayExecutor.asyCheckReturnParams(request);
    }

    public static WxpayCloseReturn orderClose(String payNo, WxPayTrade trade){
        return wxPayApi.wxPayExecutor.orderClose(payNo,trade);
    }
}
